<template>
  <div>
    <q-header reveal :reveal-offset="100" class="header shadow-18">
      ...
      <!-- Desktop -->
        ...
        <q-btn v-if="$q.platform.is.desktop" push color="secondary" class="item-nav-desktop" label="Inicia Sesion"  exact to="/login"/>
        <q-btn v-if="$q.platform.is.desktop" push color="secondary" class="item-nav-desktop" label="Registrate"  exact to="/register"/>
      </q-toolbar>
    </q-header>
    ...
    >
      <q-list class="t4 pointer uppercase">
        ...
        <q-item to="/login" exact class="item-nav-mobile">
          <q-item-section avatar >
            <q-icon name="fas fa-door-open" />
          </q-item-section>
          <q-item-section>
            <q-item-label>Ingresa</q-item-label>
          </q-item-section>
        </q-item>
        ...
        <q-item to="/register" exact class="item-nav-mobile">
          ...
          <q-item-section>
            <q-item-label>Registrate</q-item-label>
          </q-item-section>
        </q-item>
      </q-list>
    </q-drawer>
...
<style lang="scss">
  ...
  .router-link-exact-active {
    border-bottom: 2px solid $c-color7;
    color: $c-color7;
  }
  .f-center {
    width: 100%;
